 ...
 */
export enum PersonaConfidenceLevel {
  LOW = 'low',
  MEDIUM = 'medium',
  HIGH = 'high',
  VERY_HIGH = 'very_high',
...
export interface ContactPersona {
  ...
  confidenceLevel: PersonaConfidenceLevel;
 ...
 */
export interface PersonaConfidenceLevelConfig {
  level: PersonaConfidenceLevel;
  label: string;
  color: string;
  minScore: number;
  maxScore: number;
...
export const CONFIDENCE_LEVEL_CONFIGS: Record<PersonaConfidenceLevel, PersonaConfidenceLevelConfig> = {
  [PersonaConfidenceLevel.VERY_HIGH]: {
    level: PersonaConfidenceLevel.VERY_HIGH,
    label: 'Very High',
    color: '#10B981',
    minScore: 0.9,
    maxScore: 1.0,
  },
  [PersonaConfidenceLevel.HIGH]: {
  ...
  [PersonaConfidenceLevel.MEDIUM]: {
    level: PersonaConfidenceLevel.MEDIUM,
    label: 'Medium Confidence',
    color: '#F59E0B', // amber-500
    minScore: 0.5,
    maxScore: 0.79,
  },
  [PersonaConfidenceLevel.LOW]: {
