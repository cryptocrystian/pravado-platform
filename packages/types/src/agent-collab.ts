...
import { EscalationRequest } from './agent-collaboration';
...
/**
 * Active collaboration summary for a goal
 */
export interface ActiveCollaborationSummary {
  goalId: string;
  collaborators: {
    agentId: string;
    role: CollaborationRole;
...
// EscalationRequest is imported from './agent-collaboration'
