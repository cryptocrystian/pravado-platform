...
export enum ContentModerationSeverity {
  LOW = 'low',
  MEDIUM = 'medium',
  HIGH = 'high',
  CRITICAL = 'critical',
...
export interface ModerationMetrics {
  ...
  severityDistribution: Record<ContentModerationSeverity, number>;
...
export interface CategoryBreakdown {
  ...
  count: number;
  percentage: number;
  avgSeverity: ContentModerationSeverity;
...
export interface GuardrailConfig {
  ...
  autoModerationSettings: {
    enabled: boolean;
    autoRewrite: boolean;
    escalationThreshold: ContentModerationSeverity;
    blockThreshold: ContentModerationSeverity;
  };
}
